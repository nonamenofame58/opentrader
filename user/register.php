	...
	<div class="row justify-content-center">
		<div class="col-12 text-center">
			...
			if ($password != $password_2) {
				die("E-Posta yada şifre hatalı.<br> <a href='index.php'>Kayıt Ol</a>");
			}
			...
			if (userExists($username, $email)) {
				echo ('<script> window.location.href="index.php?registerEcho='."Kullanıcı Zaten Mevcut".'" </script>');
			}
			...
			if ($stmt->execute()) {
				...
				if ($stmt->affected_rows > 0) {
					echo ('<script> window.location.href="index.php?registerEcho='."Başarıyla kayıt oldunuz !".'" </script>');

					include 'inc/email.php';
					sendVerificationEmail($email,$verification_code);
				}else{echo 'Hata var';die();}
